...
class GraspRGB:
    ...
    def get_object(self):
        # Use YOLO to get object bounding box and position.
        ...
        for l in range(len(self.obj_det.bounding_boxes)):
            if self.obj_det.bounding_boxes[l].Class == 'cup':
        ...
        self.obj_pose = self.transform_pose(self.obj_pos)
        self.scene_object.pose = self.obj_pose
        # Give object dimensions.
        self.scene_object.dimensions = (0.08, 0.08, 0.25)
    ...
    def grasp(self):
        ...
        self.get_object()
        # Create an array of grasps and give it to MoveIt.
